...
parser.add_argument('--model', default='gin', help="Enter model name")
parser.add_argument('--batch_size', type=int, default=64, help='enter batch size')
parser.add_argument('--epoch', type=int, default=500, help="Enter epoch number")
parser.add_argument('--dropout', type=float, default=0, help="Enter epoch number")
parser.add_argument('--seed', type=int, default=100, help="Enter random seed")
parser.add_argument('--data_type', type=str, default="tiny", help="Enter data type")
parser.add_argument('--rem_dup', type=int, default=0, help="Remove duplicate or not")
parser.add_argument('--group', type=str, default='type', help="family or type")
